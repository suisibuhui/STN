 ...
 * Name: MViewHolder
 * Author: xulong
 * Comment: //公共adapter的ViewHolder
 * Date: 2016-08-08 10:57.
 */
public class MViewHolder
{
    ...
    public MViewHolder(Context context, View itemView, ViewGroup parent, int position)
    {
        mContext = context;
                                  ...
                                  ViewGroup parent, int layoutId, int position)
    {
        if (convertView == null)
        {
            View itemView = LayoutInflater.from(context).inflate(layoutId, parent,
                    false);
            MViewHolder holder = new MViewHolder(context, itemView, parent, position);
